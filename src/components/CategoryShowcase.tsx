...
export const CATEGORY_BANNERS: Record<string, CategoryBannerData> = {
  'INSTRUMENTAL Y ACCESORIOS': {
    ...
    subtitle: 'Turbinas de titanio, contra-ángulos, fórceps, elevadores y micro-motores con precisión suiza para procedimientos de alta exigencia.',
  ...
  'OPERATORIA': {
    ...
    subtitle: 'Resinas nanohíbridas de alta estética, adhesivos universales, ionómeros y fotocuradores con máxima opalescencia natural.',
  ...
  'DESECHABLES, ESTERILIZACION Y DESINFECCION': {
    ...
    subtitle: 'Mangas de autoclave Tyvek, indicadores químicos multiparámetro, casetes quirúrgicos y guantes de nitrilo con certificación sanitaria.',
  ...
  'ENDODONCIA': {
    ...
    subtitle: 'Limas NiTi rotatorias, localizadores apicales, conos de gutapercha y espejos de rodio con cero distorsión óptica.',
    ...
    return (
      <div className="category-context-banner" role="region" aria-label={`Banner de ${banner.title}`}>
        <div className="category-context-body">
          ...
          <button
            type="button"
            className="category-context-reset-btn"
        ...
        <div className="category-context-media">
          <img
            src={banner.image}
            alt={banner.title}
            className="category-context-img"
            loading="lazy"
          />
        </div>
      </div>
    ...
    <section className="category-showcase-hub" aria-label="Especialidades odontológicas destacadas">
      <div className="category-showcase-header">
        ...
        <span className="category-showcase-tagline">
          Fotografía de precisión y fichas técnicas homologadas
        </span>
      </div>
